...
<div class="wp-block-columns has-background" id="stream-album" style="background-color:#f3f3f3;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
    ...
    <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%">
        ...
        <div class="wp-block-group">
            ...
            <h1 class="wp-block-heading has-text-align-center has-large-font-size"><?php _e('♫ Listen to the new single ♫<br>Stream-Me-Please.mp3', 'c9-work'); ?></h1>
            <!-- /wp:heading -->
            ...
            <ul class="">
                <!-- wp:list-item -->
                <li class=""><strong><strong><span class="has-inline-color has-color-secondary-background-color">✓</span></strong> <?php _e('Song Name - Track Title', 'c9-work'); ?></strong></li>
                <!-- /wp:list-item -->

                <!-- wp:list-item -->
                <li class=""><strong><span class="has-inline-color has-color-secondary-background-color">✓</span> <?php _e('Song Name - Track Title', 'c9-work'); ?></strong></li>
                <!-- /wp:list-item -->
            ...
            <div class="wp-block-buttons">
                <!-- wp:button -->
                <div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="https://www.youtube.com/watch?v=8qyP5abkoe4" target="_blank" rel="noreferrer noopener"><?php _e('YouTube Video Pop', 'c9-work'); ?></a></div>
                <!-- /wp:button -->
            </div>
            <!-- /wp:buttons -->
        </div>
