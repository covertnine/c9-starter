...
<h1 class="wp-block-heading has-text-align-center"><mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-color-light-color"><?php _e( 'Link Promo Tree Alt', 'c9-togo' ); ?></mark></h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","fontSize":"small"} -->
<p class="has-text-align-center has-small-font-size"><?php _e( '"Link tree" style layout with button links', 'c9-togo' ); ?> + <?php _e( 'a video background', 'c9-togo' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-50"><a class="wp-block-button__link has-background wp-element-button" href="#" style="background-color:#141414"><?php _e( 'Stream Podcast', 'c9-togo' ); ?></a></div>
<!-- /wp:button -->

<!-- wp:button {"textColor":"color-light","width":50,"className":"is-style-outline"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-50 is-style-outline"><a class="wp-block-button__link has-color-light-color has-text-color wp-element-button" href="#"><?php _e( 'Tour Dates', 'c9-togo' ); ?></a></div>
<!-- /wp:button -->

<!-- wp:button {"textColor":"color-light","width":50,"className":"is-style-outline"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-50 is-style-outline"><a class="wp-block-button__link has-color-light-color has-text-color wp-element-button" href="#"><?php _e( 'Tour Promo Video', 'c9-togo' ); ?></a></div>
<!-- /wp:button -->

<!-- wp:button {"width":50,"style":{"color":{"text":"#f4f4f4"}},"className":"is-style-outline"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-50 is-style-outline"><a class="wp-block-button__link has-text-color wp-element-button" href="#" style="color:#f4f4f4"><?php _e( 'YouTube', 'c9-togo' ); ?></a></div>
<!-- /wp:button -->

<!-- wp:button {"width":50,"style":{"color":{"text":"#c6ad89eb"}},"className":"is-style-outline"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-50 is-style-outline"><a class="wp-block-button__link has-text-color wp-element-button" href="#" style="color:#c6ad89eb"><?php _e( 'Instagram', 'c9-togo' ); ?></a></div>
<!-- /wp:button -->
