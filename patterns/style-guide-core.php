...
/**
 * Title: Style Guide
 * Slug: c9-starter/style-guide-core
 * Categories: page
 * Keywords: starter
...
?>
<!-- wp:cover {"url":"' . esc_url($image_path_7) . '","id":2805,"dimRatio":70,"minHeight":611,"minHeightUnit":"px","align":"full","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|70"}}},"className":"is-light","c9ContainerWidth":""} -->
