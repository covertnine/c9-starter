...
<h1 class="wp-block-heading" style="font-size:35px"><strong><span class="has-inline-color has-color-primary-color">C9</span></strong> — Events Block Pattern</h1>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading has-medium-font-size">COVERT NINE - The nine essentials ingredients for good digital marketing. Copywriting, Design, Development, SEO, PPC, Social Media, Email, Videos, Photograph</h3>
<!-- /wp:heading -->
