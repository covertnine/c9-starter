		...
		switch ($which_selectors) {
			case 'headings':
				$selectors = array(
					...
					'.wp-block-search__button, .entry-content .btn, .entry-content .btn:visited',
					...
					'.woocommerce .c9 a.button, .woocommerce .c9 button.button',
					'.woocommerce .c9 input.button, .woocommerce a.button',
