...
(function($) {
  ...
  $(function() {
    ...
    if ($("#cortex_branding input[value='no']").is(":checked")) {
      $("label[for='cortex_branding[heading_font]']")
        .parents("tr")
        .hide();
      $("label[for='cortex_branding[subheading_font]']")
        .parents("tr")
        .hide();
      $("label[for='cortex_branding[body_font]']")
        .parents("tr")
        .hide();
    }

    $("#cortex_branding input[value='no']").click(function() {
      if ($("#cortex_branding input[value='no']").is(":checked")) {
        $("label[for='cortex_branding[heading_font]']")
          .parents("tr")
          .hide();
    ...
    $("#cortex_branding input[value='yes']").click(function() {
      $("label[for='cortex_branding[heading_font]']")
        .parents("tr")
        .show();
      $("label[for='cortex_branding[subheading_font]']")
