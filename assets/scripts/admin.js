	  ...
	  function() {
			...
			console.log( isDirty );
			  ...
			  if ($( "#cortex_typography input[value='no']" ).is( ":checked" )) {
				  $( "label[for='cortex_typography[heading_font]']" )
					.parents( "tr" )
					.hide();
            ...
            $( "#cortex_typography input[value='no']" ).click(
			  function() {
			  if ($( "#cortex_typography input[value='no']" ).is( ":checked" )) {
					$( "label[for='cortex_typography[heading_font]']" )
					  .parents( "tr" )
            ...
            $( "#cortex_typography input[value='yes']" ).click(
			  function() {
				$( "label[for='cortex_typography[heading_font]']" )
				.parents( "tr" )
				.show();
            ...
            $( "textarea[class*=code_editor_page_" ).each(
			  function() {
