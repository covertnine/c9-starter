...
$my_orders_columns = apply_filters( 'woocommerce_my_account_my_orders_columns', array(
	'order-number'  => __( 'Order', 'cortextoo' ),
	'order-date'    => __( 'Date', 'cortextoo' ),
	'order-status'  => __( 'Status', 'cortextoo' ),
	'order-total'   => __( 'Total', 'cortextoo' ),
	'order-actions' => '&nbsp;',
) );
...
if ( $customer_orders ) : ?>
	...
	<h2><?php echo apply_filters( 'woocommerce_my_account_my_orders_title', __( 'Recent orders', 'cortextoo' ) ); ?></h2>
