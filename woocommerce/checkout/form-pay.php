	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'cortextoo' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'cortextoo' ); ?></th>
			</tr>
		</thead>
		<tbody>
