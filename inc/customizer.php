...
if ( ! function_exists( 'c9_customize_register' ) ) {
	...
	function c9_customize_register( $wp_customize ) {
		...
		$wp_customize->get_setting( 'header_textcolor' )->transport = 'postMessage';
				...
				// 	array(
				// 		'type'        => 'text',
				// 		'label'       => __( 'Google Analytics ID', 'c9-starter' ),
				// 		'section'     => 'c9_seo',
				// 		'description' => __( 'Enter your Google Analytics tracking ID to have the tracking code inserted in your pages. Should begin with UA-', 'c9-starter' ),
				// 	)
				// );
