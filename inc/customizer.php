...
if (!function_exists('c9_customize_register')) {
	...
	function c9_customize_register($wp_customize)
	{
		...
		$wp_customize->add_control(
			'c9_header_hide_search',
			array(
				'label'    => __('Hide the search form in the header', 'c9-work'),
				'section'  => 'c9_header',
				'priority' => 10,
				'type'     => 'checkbox',
			)
		...
		$wp_customize->add_control(
			...
			array(
				'type'        => 'radio',
				'label'       => __('Display search in footer', 'c9-work'),
				'section'     => 'c9_footer',
				'description' => __('Hide or show the search form in the footer', 'c9-work'),
				'choices'     => array(
					'show' => __('Show', 'c9-work'),
					'hide' => __('Hide', 'c9-work'),
				),
			)
		);
		...
		$wp_customize->add_control(
			...
			array(
				'type'        => 'textarea',
				'label'       => __('Copyright', 'c9-work'),
				'section'     => 'c9_footer',
				'description' => __('Enter in any copyright information, links to privacy policies or terms.', 'c9-work'),
			)
		);
		$wp_customize->add_section(
			'c9_social',
			array(
				'title'    => __('Social Media', 'c9-work'),
				'priority' => 92,
			)
		);
		...
		$wp_customize->add_control(
			...
			array(
				'type'        => 'radio',
				'label'       => __('Display social icons in footer', 'c9-work'),
				'section'     => 'c9_social',
				'description' => __('Hide or show social icons in the footer', 'c9-work'),
				'choices'     => array(
					'show' => __('Show', 'c9-work'),
					'hide' => __('Hide', 'c9-work'),
				),
		...
		$wp_customize->add_control(
			...
			array(
				'type'        => 'text',
				'label'       => __('Twitter Link', 'c9-work'),
				'section'     => 'c9_social',
				'description' => __('Input your Twitter Username or full url', 'c9-work'),
			)
		);
		$wp_customize->add_setting(
			'c9_facebook',
		...
		$wp_customize->add_control(
			...
			array(
				'type'        => 'text',
				'label'       => __('Facebook Link', 'c9-work'),
				'section'     => 'c9_social',
				'description' => __('Input your Facebook username or full url', 'c9-work'),
			)
		);
		$wp_customize->add_setting(
			'c9_instagram',
		...
		$wp_customize->add_control(
			...
			array(
				'type'        => 'text',
				'label'       => __('Instagram Link', 'c9-work'),
				'section'     => 'c9_social',
				'description' => __('Input your Instagram username or full url', 'c9-work'),
			)
		);
		$wp_customize->add_setting(
			'c9_pinterest',
		...
		$wp_customize->add_control(
			...
			array(
				'type'        => 'text',
				'label'       => __('Pinterest Link', 'c9-work'),
				'section'     => 'c9_social',
				'description' => __('Input your Pinterest username or full url', 'c9-work'),
			)
		);
		...
		$wp_customize->add_control(
			...
			array(
				'type'        => 'text',
				'label'       => __('Spotify Link', 'c9-work'),
				'section'     => 'c9_social',
				'description' => __('Input your Spotify username or full url', 'c9-work')
			)
		);
		...
		$wp_customize->add_control(
			...
			array(
				'type'        => 'text',
				'label'       => __('YouTube Link', 'c9-work'),
				'section'     => 'c9_social',
				'description' => __('Input your YouTube username or full url', 'c9-work'),
			)
		);
		...
		$wp_customize->add_control(
			...
			array(
				'type'        => 'text',
				'label'       => __('Yelp Link', 'c9-work'),
				'section'     => 'c9_social',
				'description' => __('Input your Yelp username or full url', 'c9-work'),
			)
		);
		...
		$wp_customize->add_control(
			...
			array(
				'type'        => 'text',
				'label'       => __('Subreddit Link', 'c9-work'),
				'section'     => 'c9_social',
				'description' => __('Input your Subreddit url', 'c9-work'),
			)
		);
		...
		$wp_customize->add_control(
			...
			array(
				'type'        => 'text',
				'label'       => __('LinkedIn Link', 'c9-work'),
				'section'     => 'c9_social',
				'description' => __('Input your LinkedIn url', 'c9-work'),
			)
		);
		...
		$wp_customize->add_control(
			...
			array(
				'type'        => 'text',
				'label'       => __('Github Link', 'c9-work'),
				'section'     => 'c9_social',
				'description' => __('Input your Github username or full url', 'c9-work'),
			)
		);
		...
		$wp_customize->add_control(
			...
			array(
				'type'        => 'text',
				'label'       => __('SoundCloud Link', 'c9-work'),
				'section'     => 'c9_social',
				'description' => __('Input your SoundCloud username or full url', 'c9-work'),
			)
		);
		$wp_customize->add_section(
			'c9_branding',
			array(
				'title'    => __('Branding', 'c9-work'),
				'priority' => 20,
			)
		);
		...
		$wp_customize->add_control(
			...
			array(
				'type'    => 'radio',
				'label'   => __('Use C9 Theme Fonts?', 'c9-work'),
				'section' => 'c9_branding',
				'choices' => array(
					'yes' => __('Yes', 'c9-work'),
					'no'  => __('No, I will queue my own fonts.', 'c9-work'),
				),
			)
		);
		...
		$wp_customize->add_control(
			...
			array(
				'type'        => 'select',
				'label'       => __('Heading Font', 'c9-work'),
				'description' => __('Select your heading font family.', 'c9-work'),
				'section'     => 'c9_branding',
				'choices'     => $c9fonts,
			)
		);
		...
		$wp_customize->add_control(
			...
			array(
				'type'        => 'select',
				'label'       => __('Subheading Font', 'c9-work'),
				'description' => __('Select your subheading font family.', 'c9-work'),
				'section'     => 'c9_branding',
				'choices'     => $c9fonts,
			)
		);
		...
		$wp_customize->add_control(
			...
			array(
				'type'        => 'select',
				'label'       => __('Body Paragraph Font', 'c9-work'),
				'description' => __('Select your base font family.', 'c9-work'),
				'section'     => 'c9_branding',
				'choices'     => $c9fonts,
			)
		);
		...
		$wp_customize->add_control(
			...
			array(
				'type'        => 'checkbox',
				'label'       => __('Fade-in custom fonts as they download', 'c9-work'),
				'description' => __('Select this if you notice a flash of the default font as the custom fonts download the first time a user visits the site.', 'c9-work'),
				'section'     => 'c9_branding',
			)
		);
		...
		$wp_customize->add_control(
			...
			array(
				'type'    => 'radio',
				'label'   => __('Do you want to show or hide the author name on posts?', 'c9-work'),
				'section' => 'c9_posts',
				'choices' => array(
					'show' => __('Show', 'c9-work'),
					'hide' => __('Hide', 'c9-work'),
		...
		$wp_customize->add_control(
			...
			array(
				'type'    => 'radio',
				'label'   => __('Display a sidebar on single posts?', 'c9-work'),
				'section' => 'c9_posts',
				'choices' => array(
					'hide'          => __('No Sidebar', 'c9-work'),
					'sidebar-left'  => __('Left Sidebar', 'c9-work'),
					'sidebar-right' => __('Right Sidebar', 'c9-work'),
				),
			)
		);
		...
		$wp_customize->add_control(
			...
			array(
				'type'    => 'radio',
				'label'   => __('Display a sidebar on archive pages?', 'c9-work'),
				'section' => 'c9_posts',
				'choices' => array(
					'hide'          => __('No Sidebar', 'c9-work'),
					'archive-left'  => __('Left Sidebar', 'c9-work'),
					'archive-right' => __('Right Sidebar', 'c9-work'),
				),
			)
		);
	}
