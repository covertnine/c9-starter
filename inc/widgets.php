...
if (!function_exists('c9_widgets_init')) {
	...
	function c9_widgets_init()
	{
		register_sidebar(
			array(
				'name'          => __('Footer', 'c9-music'),
				'id'            => 'footerfull',
				'description'   => __('Full bottom widget with dynamic responsive grid that shows on every page. Suggested 3-6 widgets.', 'c9-music'),
		...
		register_sidebar(
			array(
				'name'          => __('Right Sidebar', 'c9-music'),
				'id'            => 'right-sidebar',
				'description'   => __('Right sidebar widget area displayed when using the Right Sidebar Layout page template. Widget content fades in after scrolling down on frontend..', 'c9-music'),
		...
		register_sidebar(
			array(
				'name'          => __('Left Sidebar', 'c9-music'),
				'id'            => 'left-sidebar',
				'description'   => __('Left sidebar widget area displayed when using the Right Sidebar Layout page template. Widget content fades in after scrolling down on the frontend.', 'c9-music'),
				'before_widget' => '<aside id="%1$s" class="widget sidebar-widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
