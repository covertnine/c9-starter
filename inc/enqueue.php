...
if (!function_exists('cortextoo_scripts')) {
	...
	function cortextoo_scripts()
	{
		...
		$js_version = $theme_version . '.' . filemtime(get_template_directory() . '/js/dist/theme.min.js');
		wp_enqueue_script('cortextoo-scripts', get_template_directory_uri() . '/js/dist/theme.min.js', array('jquery'), $js_version, true);
