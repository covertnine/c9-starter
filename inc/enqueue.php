...
if ( ! function_exists( 'c9_scripts' ) ) {
	...
	function c9_scripts() {
		...
		if ( ! empty( $font_choice ) && 'yes' === $font_choice ) {
			...
			$font_array 						= array();
			$font_array['c9_heading_font'] 		= get_theme_mod( 'c9_heading_font','Sen' );
			$font_array['c9_subheading_font'] 	= get_theme_mod( 'c9_subheading_font', 'Sen' );
			$font_array['c9_body_font'] 		= get_theme_mod( 'c9_body_font', 'Sen' );
