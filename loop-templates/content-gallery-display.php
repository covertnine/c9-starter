                                ...
                                <div class="grid-item <?php echo $cortex_columns; ?>">
                                    <figure class="img_container">
                                        <a href="<?php echo esc_url($cortex_image['url']); ?>" class="entry-link" title="<?php echo esc_html($cortex_image['caption']); ?>">
                                            <img src="<?php echo esc_url($cortex_image['sizes']['large']); ?>" alt="<?php echo esc_html($cortex_image['alt']); ?>" /></a>
                                    </figure>
                                </div>
                        <?php endforeach;
                        } //endforeach
                    ...
                    if (!empty($cortex_images)) {
                        foreach ($cortex_images as $cortex_image) :  ?>
                            <div class="entry-content-image">
                                <img src="<?php echo esc_url($cortex_image['url']); ?>" alt="<?php echo esc_html($cortex_image['alt']); ?>" class="mar10B" />
                            </div>
                    <?php endforeach;
                    } //endifempty
                    ?>
