...
= 2.7.9 =
Fixing bug with buttons on search results. (Shout out to Ron) Layout fix for some of the promo link pattern layouts.

= 2.7.8 =
Bug fix to preview on new posts.

= 2.7.7 =
Wide cover block alignment in backend fix on some pages.
...
= 2.7.2 =
Bug fixes for WordPress 6.5 and block pattern updates.
...
= 2.6.9 =
New block pattern for a social link tree. Fix to alignwide cover block. Fix to some build tool steps. 

= 2.6.8 =
Fix on block search widget, fixes to block patterns, fixes to cover block alignments, alignment bug fixes for WordPress 6.4.2.

= 2.6.7 =
Update to some list item spacing.

= 2.6.6 =
Updating block patterns for WordPress 6.4.

= 2.6.5 =
Bug fixes related to buttons and social icons. Added more Google Fonts. Tested with WordPress 6.2.
