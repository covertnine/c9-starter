...
= 2.4.5 =
Fixed some alignment bugs. Updated markup for block patterns. Bug fixes for some minor font issues. New sample content.
...
= 2.4.2 =
Removed starter-content since it causes errors on some setups. 

= 2.4.1 =
Returned to rem font sizes for better mobile font sizing. List style updates. Theme.json font size updates. Bug fixs for WP 6.1 markup.

= 2.4.0 =
List item disc bug fixed.
...
= 2.3.7 =
Updated translation strings and default translation files.
...
= 2.3.4 =
Updates to spacing classes and updates for social icon block in WordPress 5.9

= 2.3.3 =
Updating packages for development. WordPress 5.9 copmatibility updates. Button updates, backend font bug fixes, better accessibility updates.
