...
= 2.5.5 =
Updated for WordPress 6.5 with new block patterns for new pages/posts, new markup for backend, fixes to some alignments with cover blocks.
...
= 2.5.2 =
Removing starter-content causing errors on some setups.

= 2.5.1 =
Fixes for filesystem errors on some servers.
...
= 2.4.8 =
Compatibility updates for WordPress 6.0. Fixes to list items and font sizes on some blocks.

= 2.4.7 =
Updated for WordPress 5.9.2 compatibility. Updates to button styling, list stylings, bugs on some browsers in admin.

= 2.4.6 =
Fixing some errors related to older versions of PHP. Fixing 3 default setting arrays in customizer to prevent sanitize missing error.

= 2.4.5 =
Updating classes on blank template so CSS for core blocks remains consistent. Updated WooCommerce default shop page.
...
= 2.4.2 =
Fixes to some font weights of headings, nav tab colors in style guide.
