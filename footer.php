									...
									<div class="container">
										<div class="row text-center d-flex justify-content-between align-items-center">
											...
											if (!empty($c9_footer_copyright)) {
												echo '<div class="col-xs-12 mr-auto ml-auto p-0 footer-copyright-wrapper"><p class="text-center copyright light-color-text">' . wp_kses_post($c9_footer_copyright) . '</p></div>';
											}
