...
if ( file_exists( locate_template( 'client/inc/footer.php' ) ) ) {
	...
	include( locate_template( 'client/inc/footer.php' ) );
		...
		$c9_footer_default = '&copy; ' . date("Y") . '. <a href="https://www.covertnine.com" title="' . __('Web design company in Chicago', 'c9-togo') . '" target="_blank">' . __('WordPress Website design by COVERT NINE', 'c9-togo') . '</a>.';
