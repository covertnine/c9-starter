...
function c9_need_client_folder()
{
    ...
    <div class="update-nag notice">
        <p><?php _e('You need a client! If you have no client-specific code, add an empty client/client.php to the parent theme. If you still dont know what&#39;s going on, contact connect@covertnine.com', 'c9-togo'); ?></p>
    </div>
    <?php
}
