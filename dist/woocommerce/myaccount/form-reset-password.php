...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
		<label for="password_1"><?php esc_html_e( 'New password', 'cortextoo' ); ?> <span class="required">*</span></label>
	...
	<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
		<label for="password_2"><?php esc_html_e( 'Re-enter new password', 'cortextoo' ); ?> <span class="required">*</span></label>
	...
	<p class="woocommerce-form-row form-row">
		...
		<button type="submit" class="btn btn-outline-primary" value="<?php esc_attr_e( 'Save', 'cortextoo' ); ?>"><?php esc_html_e( 'Save', 'cortextoo' ); ?></button>
	</p>
