...
if (!class_exists('WP_OSA')) :
	...
	class WP_OSA
	{
		...
		public function admin_scripts()
		{
			...
			if (array_key_exists('page', $_GET) && 'wp_osa_settings' === $_GET['page']) {
				wp_enqueue_code_editor(array('type' => 'text/html'));
			}

			wp_enqueue_script('admin-js', get_template_directory_uri() . '/assets/scripts/admin.js', array('jquery'), '', true);
